...
export const COLOR_CLIMB_TYPE: Record<(typeof CLIMB_TYPE)[number], ColorPath> =
	{
		Board: "amethyst-smoke.DEFAULT",
		Boulder: "mojo.DEFAULT",
		Route: "white-rock.DEFAULT",
		Trad: "green-smoke.DEFAULT",
	};
